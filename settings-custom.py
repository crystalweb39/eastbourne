...
import sys
sys.path = ['/usr/lib/python2.4/site-packages','/usr/lib/python2.4/site-packages/PIL'] + sys.path
...
USE_I18N = False
DOMAIN = 'www.eastbourneart.com.au'
USERNAME = 'Trish.Fraunfelter_api1.eastbourneart.com.au'
PASSWORD = 'WEW64ZQND8PN4EJW'
SIGNATURE = 'ALH14Vh5HUqNptiWLzp8qGYj22MgA6o-a1s-fUlk7gFBsII8UMiZ1cXg'
...
STRICT_PIL = False
STATIC_URL = '/media/'
STATIC_ROOT = '/var/www/vhosts/eastbourneart.com.au/httpdocs/media/'
# list of names not allowed for folders
DISALLOWED_FOLDER_NAMES = ['mkdir', 'upload', 'rename', 'delete']


MEDIA_ROOT = '/var/www/vhosts/eastbourneart.com.au/httpdocs/media/'
...
#    'django.middleware.csrf.CsrfViewMiddleware',    
    'eastbourne.Middleware.SecureRequiredMiddleware',
)
